function ProcessEyeData_Stage1(cond,subsStart, subsEnd)
...
%     subCondName = ['C2_S10001_ET1'];
    ...
    if exist(strcat(fileName, '.mat'), 'file') ~= 0;
        ...
        for period = 1:3
            for t = 1:trials;
                ...
                switch period
                    case 1
                        EGdata = cell2mat(DATAEG.part1.Fix(t,1));
                        ts = cell2mat(DATAEG.part1.Fix(t,2));
                        TotalTime = (DATAEG.part1.Fix{t,2}(end) - DATAEG.part1.Fix{t,2}(1))/1000;   
                    case 2
                        EGdata = cell2mat(DATAEG.part1.Dec(t,1));
                        ts = cell2mat(DATAEG.part1.Dec(t,2));
                        TotalTime = (DATAEG.part1.Dec{t,2}(end) - DATAEG.part1.Dec{t,2}(1))/1000; 
                    case 3
                        EGdata = cell2mat(DATAEG.part1.FB(t,1));
                        ts = cell2mat(DATAEG.part1.FB(t,2));
                        TotalTime = (DATAEG.part1.FB{t,2}(end) - DATAEG.part1.FB{t,2}(1))/1000; 
                end
    ...
    %             EGdata(EGdata(:,1)==0,:) = [];
            ...
            fileName = ['Processed Data (Stage 1)\', subCondName, '_processed'];
