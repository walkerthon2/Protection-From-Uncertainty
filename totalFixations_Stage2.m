function totalFixations_Stage2(cond,subs)
...
%      subCondName = ['C2_S10001_ET1_processed'];
    ...
    fileName = ['Processed Data (Stage 2)\', subCondName];
...
%     end
    ...
    if trackCounter > trials / 2;
        fprintf('Participant %d has less than half of trials with a fixation on either cue  in Stage 3\n', s);
    end
    ...
    fileName = ['Final Data (Stage 2)\', subCondName, '_final'];
